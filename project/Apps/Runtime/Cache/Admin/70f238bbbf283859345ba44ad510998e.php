                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Admin/Auth/add');?>">权限添加</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Auth/typeadd');?>">组权限添加</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Auth/typeindex');?>">组权限显示</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Auth/index');?>">用户权限</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <?php  $AUTH = new \Think\Auth(); if($AUTH->check('Admin/User/index', session('uid'))){ ?>
                        <li>
                       ...
                       <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Admin/Message/index');?>">微博列表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 关注管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Admin/Relation/index');?>">关注列表</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Relation/index');?>">关注列表</a>
                                </li>
                        ...
                        <?php  $AUTH = new \Think\Auth(); if($AUTH->check('Admin/Collection/index', session('uid'))){ ?>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>收藏管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Admin/Collection/index');?>">收藏列表</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Collection/index');?>">关注列表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                          <div class="row">
                                <form action="<?php echo U('Admin/Message/index');?>" method="get">
                                    <div class="col-sm-6">
                                       <div class="dataTables_length" id="dataTables-example_length">
                                        <label>每页显示&nbsp; 
                                         <select name="num" aria-controls="dataTables-example" class="form-control input-sm">
                                          ...
                                          <option value="15" <?php if($num == 15): ?>selected<?php endif; ?>>15</option>
            ...
            <div class="row">
             <div class="col-sm-12">
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row">
                           <th class="sorting_asc text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 38px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">id</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 85px;" aria-label="Browser: activate to sort column ascending">用户名</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 40px;" aria-label="Browser: activate to sort column ascending">用户id</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 108px;" aria-label="Engine version: activate to sort column ascending">内容</th>
                           ...
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 77px;" aria-label="CSS grade: activate to sort column ascending">时间</th>
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sid text-center"><?php echo ($vo["id"]); ?></td>
                            <td class="text-center"><?php echo ($vo["username"]); ?></td>
                            <td class="text-center"><?php echo ($vo["userid"]); ?></td>
                            <td class="center text-center" ><?php echo (substr($vo["content"],0,10)); ?></td>
                            <td class="center text-center" ><?php echo ($vo["type"]); ?></td>
                            <td class="center text-center"><?php echo ($vo["time"]); ?></td>
                            <td class="center text-center">
                                <button class="btn btn-danger btn-circle btn-del text-center" type="button"><i class="fa fa-times"></i></button>
                                详情待写
                                <!-- <a href="<?php echo U('Admin/Message/edit',array('id'=>$vo['id']));?>">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.btn-del').click(function(){
           ...
           // alert(v);
           //发送ajax
           var url = "<?php echo U('Admin/Message/delete');?>";
           var btn = $(this);
           $.ajax({
                url:url,
                data:{id:v},
