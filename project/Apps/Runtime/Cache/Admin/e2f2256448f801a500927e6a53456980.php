        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Auth/update');?>" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo ($username['uid']); ?>">
                                <div class="form-group">
                                    <label>用户名</label>
                                    <input value="<?php echo ($username['username']); ?>" id="disabledInput"  name="username" placeholder="请输入用户名" class="form-control">
                                </div>                              
                                <div class="form-group">
                                    <label>权限</label>
                                    <select name="type" class="form-control">
                                        <?php if(is_array($types)): foreach($types as $key=>$vo): ?><option value="<?php echo $vo['id'];?>" 
                                            <?php  if($vo['id']==$username['group_id']) { echo 'selected'; } ?>
