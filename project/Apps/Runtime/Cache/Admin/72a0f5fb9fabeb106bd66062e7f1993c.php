                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/User/update');?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>头像上传</label>
                                    <div><img src="/project/Public/<?php echo ($info['pic']); ?>" width="100px"></div>
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="checkbox-inline">
                                        <input name="hobby[]" value="排球" type="checkbox" <?php if(in_array('排球',$hobby)): ?>checked<?php endif; ?>>排球
                                    </label>
                                    <label class="checkbox-inline">
                                        <input name="hobby[]" value="台球" type="checkbox" 
                                        <?php  if(in_array('台球',$hobby)){ echo 'checked';} ?>>台球
                                    </label>
                                    <label class="checkbox-inline">
                                        <input name="hobby[]" value="乒乓球" type="checkbox"
                                        <?php  if(in_array('乒乓球',$hobby)){ echo 'checked';} ?>
                                        >乒乓球
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input  type="radio" checked="" value="1" id="optionsRadiosInline1" name="sex" <?php if($info['sex'] == 1): ?>checked<?php endif; ?>>男
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" value="0" id="optionsRadiosInline2" name="sex" <?php if($info['sex'] == 0): ?>checked<?php endif; ?>>女
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" value="2" id="optionsRadiosInline3" name="sex" <?php if($info['sex'] == 2): ?>checked<?php endif; ?>>保密
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label>角色</label>
                                    <select name="level" class="form-control">
                                        <option value="0" <?php if($info['level'] == 0): ?>selected<?php endif; ?>>游客</option>
                                        <option value="1" <?php if($info['level'] == 1): ?>selected<?php endif; ?>>会员</option>
                                        <option value="2" <?php if($info['level'] == 2): ?>selected<?php endif; ?>>管理员</option>
                                        <option value="3" <?php if($info['level'] == 3): ?>selected<?php endif; ?>>超级管理员</option>
                                    </select>
                                </div>
