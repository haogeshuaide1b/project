                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                                <form action="<?php echo U('Admin/Collection/index');?>" method="get">
                                    <div class="col-sm-6">
                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row">
                           ...
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 77px;" aria-label="CSS grade: activate to sort column ascending">收藏时间</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 77px;" aria-label="CSS grade: activate to sort column ascending">被收藏微博id</th>
                   ...
                   <tbody>
                    <!-- z这是用户列表的遍历 -->
                    <?php if(is_array($collections)): foreach($collections as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="center text-center"><?php echo ($vo["messageid"]); ?></td>
