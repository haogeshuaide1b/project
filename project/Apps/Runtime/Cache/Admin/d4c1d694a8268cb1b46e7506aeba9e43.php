...
<body>
    ...
    <script type="text/javascript" charset="utf-8" src="/project/Public/Admin/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/project/Public/Admin/ueditor/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="/project/Public/Admin/ueditor/lang/zh-cn/zh-cn.js"></script>
    <!-- /project/Public/Admin/ueditor/ueditor.config.js -->
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Auth/typeinsert');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>添加权限组名</label>
                                    <input name="name" placeholder="请输入权限组名" class="form-control">
                                </div>
                               <div class="form-group">
                                    <label>权限添加</label>
                                    <?php if(is_array($auths)): foreach($auths as $key=>$vo): ?><label class="checkbox-inline">
                                        <input name="rules[]" value="<?php echo $vo["id"];?>" type="checkbox"><?php echo ($vo["title"]); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input  type="radio" checked="" value="1" id="optionsRadiosInline1" name="status">开启
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" value="0" id="optionsRadiosInline2" name="status">关闭
                                    </label>
                                </div>
