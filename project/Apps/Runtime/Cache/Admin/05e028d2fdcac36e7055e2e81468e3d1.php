            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo U('Admin/Login/out');?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                          <form action="<?php echo U('Admin/Auth/index');?>" method="get">
                              <div class="col-sm-6">
                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <?php
 foreach ($type as $k => $v) { if($vo['type']==$v['id']){ echo $v['title']; } } ?>
                            </td>
                            <td class="center text-center">
                                <button class="btn btn-danger btn-circle btn-del text-center" type="button"><i class="fa fa-times"></i></button>
                                <a href="<?php echo U('Admin/Auth/edit',array('id'=>$vo['id'],'username'=>$vo['username']));?>">
