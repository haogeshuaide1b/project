                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                          <form action="<?php echo U('Admin/Auth/typeindex');?>" method="get">
                              <div class="col-sm-6">
                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row">
                           ...
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 135px;" aria-label="Platform(s): activate to sort column ascending">组名</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 77px;" aria-label="CSS grade: activate to sort column ascending">权限</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 77px;" aria-label="CSS grade: activate to sort column ascending">是否开启</th>
                   ...
                   <tbody>
                    <!-- z这是用户列表的遍历 -->
                    <?php if(is_array($types)): foreach($types as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sid text-center"><?php echo ($vo["id"]); ?></td>
                            <td class="text-center"><?php echo ($vo["title"]); ?></td>
                            <td class="sid text-center"><?php echo ($vo["rules"]); ?></td>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.btn-del').click(function(){
          ...
          //alert(v);
           //发送ajax
           var url = "<?php echo U('Admin/Auth/typedelete');?>";
           var btn = $(this);
           $.ajax({
                url:url,
                data:{id:v},
