                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                                <form action="<?php echo U('Admin/Relation/index');?>" method="get">
                                    <div class="col-sm-6">
            ...
            <div class="row">
             <div class="col-sm-12">
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row">
                           <th class="sorting_asc text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 128px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">id</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 135px;" aria-label="Platform(s): activate to sort column ascending">用户id</th>
                           ...
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 108px;" aria-label="Engine version: activate to sort column ascending">被关注的id</th>
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 108px;" aria-label="Engine version: activate to sort column ascending">被关注的用户名</th>
                   ...
                   <tbody>
                    <!-- z这是用户列表的遍历 -->
                    <?php if(is_array($relation)): foreach($relation as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="text-center"><?php echo ($vo["userbyid"]); ?></td>
                            <td class="center text-center"><?php echo ($vo["userbyname"]); ?></td>
                            <td class="center text-center">
                                <button class="btn btn-danger btn-circle btn-del text-center" type="button"><i class="fa fa-times"></i></button>
                                <a href="<?php echo U('Admin/User/edit',array('id'=>$vo['id']));?>">
