            ...
            <div class="row">
             <div class="col-sm-12">
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row">
                           <th class="sorting_asc text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 128px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">头像</th>
                           ...
                           <th class="sorting text-center" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 108px;" aria-label="Engine version: activate to sort column ascending">邮箱</th>
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sorting_1 text-center"><img src="/project/Public/<?php echo ($vo["pic"]); ?>" height="50px"></td>
                            <td class="sid text-center"><?php echo ($vo["id"]); ?></td>
                            <td class="text-center"><?php echo ($vo["username"]); ?></td>
                            <td class="center text-center" ><?php echo ($vo["email"]); ?></td>
                            <td class="center text-center"><?php echo ($vo["level"]); ?></td>
